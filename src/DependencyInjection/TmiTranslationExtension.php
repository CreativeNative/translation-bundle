...
final class TmiTranslationExtension extends Extension implements PrependExtensionInterface
{
    ...
    public function load(array $configs, ContainerBuilder $container): void
    {
        ...
        /** @var array{default_locale: string, disabled_firewalls: list<string>, enable_logging: bool, copy_source: bool, strict_orphan_check: bool|null, unique_locale_variants: bool, cascade_remove_locale_variants: bool} $config */
